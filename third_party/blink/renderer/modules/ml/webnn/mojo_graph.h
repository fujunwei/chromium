...
class MojoGraph : public MLGraph {
 ...
 private:
  bool BuildGraph(BuildRequest* request, String& error_message);
  ...
  HashMap<String, mojo::ScopedSharedBufferMapping> inputs_buffer_mapping_;
  mojo::ScopedSharedBufferHandle inputs_buffer_handle_;
