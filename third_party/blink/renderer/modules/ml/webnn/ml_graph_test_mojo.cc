...
struct GemmTester {
  ...
  GemmOptions<OperandInfoBlink> options;
  OperandInfoMojo expected_operand;
  GemmOptions<OperandInfoMojo> expected_attributes;
  ...
  void Test(MLGraphTestMojo& helper,
    ...
    EXPECT_EQ(gemm_attributes->alpha, expected_attributes.alpha.value());
    EXPECT_EQ(gemm_attributes->beta, expected_attributes.beta.value());
    EXPECT_EQ(gemm_attributes->a_transpose,
              expected_attributes.a_transpose.value());
    EXPECT_EQ(gemm_attributes->b_transpose,
              expected_attributes.b_transpose.value());
...
TEST_P(MLGraphTestMojo, GemmTest) {
  ...
  //       .expected_operand = {.type =
  //       blink_mojom::Operand::DataType::kFloat32,
  //                            .dimensions = {1, 3, 2, 2}},
  //       .expected_attributes = {.window_dimensions = Vector<uint32_t>({3,
  //       3}),
  ...
  //       blink_mojom::Operand::DataType::kFloat32,
  //                            .dimensions = {1, 3, 5, 5}},
  //       .expected_attributes = {.window_dimensions = Vector<uint32_t>({5,
  //       5}),
  //                               .padding = Vector<uint32_t>({0, 0, 0, 0}),
  //                               .strides = Vector<uint32_t>({1, 1}),
  //                               .dilations = Vector<uint32_t>({1, 1}),
  ...
  //       blink_mojom::Operand::DataType::kFloat32,
  //                            .dimensions = {1, 3, 3, 3}},
  //       .expected_attributes = {.window_dimensions = Vector<uint32_t>({4,
  //       4}),
  //                               .padding = Vector<uint32_t>({1, 1, 1, 1}),
  //                               .strides = Vector<uint32_t>({2, 2}),
  //                               .dilations = Vector<uint32_t>({1, 1}),
