...
#ifndef CONTENT_BROWSER_ML_WEBNN_DML_GRAPH_NODE_OUTPUT_H_
#define CONTENT_BROWSER_ML_WEBNN_DML_GRAPH_NODE_OUTPUT_H_
...
class NodeOutput final {
 public:
  explicit NodeOutput(Node node, uint32_t output_index, TensorDesc tensor_desc);
  ~NodeOutput();
...
#endif  // CONTENT_BROWSER_ML_WEBNN_DML_GRAPH_NODE_OUTPUT_H_
